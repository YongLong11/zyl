...
public class XmindParser {
     ...
     */
    public static Attached getXmindRootBean(InputStream inputStream) throws IOException, JSONException, ArchiveException, DocumentException {
        //1. 将文件解压缩
...
//    }
    ...
    public static String getXmindLegacyContent(String destFileName) throws IOException, JSONException, DocumentException {
        List<String> fileNameList = new ArrayList<>();
