package com.zyl.something.http;
...
========================================================================================================================
     ...
     * @return
     */
    public static String get(String url, Map<String,Object> map, final Map<String, String> headers) {
        return get(url, map, headers, callback);
    }

    /**
     *  返回请求的实体
     */
    public static <T> T get(String url, Map<String,Object> map, final Map<String, String> headers, Class<T> clazz) {
        String resStr = get(url, map, headers, callback);
        return JSON.parseObject(resStr, clazz);
    }

    public static <T> T get(final String url, Map<String,Object> map, final Map<String, String> headers, final BiFunction<Integer, String, T> callback) {
        return get(url, getParameter(map), headers, callback);
    }

    public static <T> T get(final String url, final String paramData, final Map<String, String> headers, final BiFunction<Integer, String, T> callback) {
