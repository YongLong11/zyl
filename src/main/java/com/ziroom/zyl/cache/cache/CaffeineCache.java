package com.ziroom.zyl.cache.cache;
...
public class CaffeineCache implements com.ziroom.zyl.cache.cache.Cache {
    private final Cache<String, Object> cache;

    private com.ziroom.zyl.cache.cache.Cache redisCache;

    public CaffeineCache(com.ziroom.zyl.cache.cache.Cache cache, int duration){
        this(cache, CacheConstant.minSize, CacheConstant.maxSize, duration);
    }

    public CaffeineCache(com.ziroom.zyl.cache.cache.Cache cache, int minSize, int maxSize, int duration){
